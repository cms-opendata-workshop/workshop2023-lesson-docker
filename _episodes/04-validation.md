...
<blockquote class="testimonial">
  <h2> CMSSW jobs still not running in a container on a MacOS with M1 chip? </h2>
...
<!--  <p>For the CMS open data workshop, we provide a <a href=" http://docker.cms-cloud.net/">temporary solution</a> which gives a docker environment in browser. You can use it for the CMSSW container during the lessons, if needed. Note the following: <ul>
